<div class="footer">
    <div class="wrap">
        <div class="section group">
            <div class="col_1_of_4 span_1_of_4">
                <h4>Liên kết</h4>
                <ul>
                    <li><a href="{{route('trangchu')}}">Pin laptop</a></li>
                    <li><a href="{{route('trangchu')}}">Sửa laptop nhanh</a></li>
                    <li><a href="{{route('trangchu')}}">Laptop rẻ</a></li>
                    <li><a href="{{route('trangchu')}}">Laptop đà nẵng</a></li>
                </ul>
            </div>
            <div class="col_1_of_4 span_1_of_4">
                <h4>Bản đồ</h4>
                <ul>
                    <li>
                        <a href=""><img width="120px" style="text-align: center;" src="user/images/slider/bando.png" alt=""></a>
                    </li>
    ...
    <div class="">
        <a href="{{route('trangchu')}}"><img style="float: right; position: fixed" src="user/images/slider/home2.png" alt=""></a>
    </div>

    <div class="copy_right">
        <p>&copy; 2019 Laptop_home</p>
    </div>
